...
public class UserControllerTest {
    ...
    public void testRegisterUser() throws Exception {
        String requestBody = "{\"firstName\": \"Ajinkya\",\"lastName\": \"Kale\",\"email\": \"ajinkode@gmail.com\",\"password\": \"password\",\"role\": \"USER\"}";

        User user = new User();
        user.setId(1);
        user.setFirstName("Ajinkya");
        user.setLastName("Kale");
        user.setEmail("ajinkode@gmail.com");
        ...
        mockMvc.perform(post("/users/register")
            ...
            .andExpect(jsonPath("$.firstName").value("Ajinkya"))
            .andExpect(jsonPath("$.lastName").value("Kale"))
            .andExpect(jsonPath("$.email").value("ajinkode@gmail.com"))
    ...
    public void testLoginUser() throws Exception {
        String requestBody = "{\"email\": \"ajinkode@gmail.com\",\"password\": \"password\"}";
